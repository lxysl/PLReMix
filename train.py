...
from utils.train_utils import adjust_lr, resume, save, init_prototypes, gmm_selection, uniform_warmup, uniform_train, val
...
parser.add_argument('--backbone', default='preact_resnet18', type=str)
...
parser.add_argument('--crl', default='flat_plr', type=str, choices=['plr', 'flat_plr'])
...
def main():
    ...
    while epoch < args.num_epochs + 1:
        ...
        adjust_lr(args.lr, args.cos, optimizer1, optimizer2, epoch, args.num_epochs)
